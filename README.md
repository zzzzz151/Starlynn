...
A [UCI](https://www.chessprogramming.org/UCI) chess engine using the negamax search algorithm with various enhancements such as alpha-beta pruning, and a neural network (NNUE) with a value head for static position evaluation and a policy head for move ordering, trained with the custom trainer [Starway](https://github.com/zzzzz151/Starway)
